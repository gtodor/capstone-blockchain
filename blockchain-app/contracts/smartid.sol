...
contract SmartIdentity {
     ...
     */
    function setOwner(address _newowner) onlyBy(override) blockLock() returns(bool) {
        owner = _newowner;
     ...
     */
    function setOverride(address _override) onlyBy(owner) blockLock() returns(bool) {
        override = _override;
